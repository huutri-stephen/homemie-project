...
var TokenWhere = struct {
	...
	TokenType: whereHelperstring{field: "\"tokens\".\"token_type\""},
...
var (
	tokenAllColumns            = []string{"id", "user_id", "token_type", "token", "expires_at", "created_at", "updated_at"}
	tokenColumnsWithoutDefault = []string{"user_id", "token_type", "token", "expires_at"}
